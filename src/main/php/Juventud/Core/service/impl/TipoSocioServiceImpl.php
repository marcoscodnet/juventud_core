...
use Juventud\Core\service\ITipoSocioService;
...
/**
 * servicio para TipoSocio
 *  
 * @author Marcos
 * @since 19-02-2017
 *
 */
class TipoSocioServiceImpl extends CrudService implements ITipoSocioService {

	
	protected function getDAO(){
		return DAOFactory::getTipoSocioDAO();
	}
