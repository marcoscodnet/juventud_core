 ...
 */
class Year extends \Juventud\Core\model\Year implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Juventud\\Core\\model\\Year' . "\0" . 'nombre', '' . "\0" . 'Juventud\\Core\\model\\Year' . "\0" . 'cuotas', '' . "\0" . 'Juventud\\Core\\model\\Year' . "\0" . 'monto'];
        }
