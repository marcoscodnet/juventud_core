 ...
 */
class TipoSocio extends \Juventud\Core\model\TipoSocio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Juventud\\Core\\model\\TipoSocio' . "\0" . 'tipo', '' . "\0" . 'Juventud\\Core\\model\\TipoSocio' . "\0" . 'pagaCuota'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoSocio $proxy) {
