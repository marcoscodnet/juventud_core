 ...
 */
class MontoCuota extends \Juventud\Core\model\MontoCuota implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Juventud\\Core\\model\\MontoCuota' . "\0" . 'nro', '' . "\0" . 'Juventud\\Core\\model\\MontoCuota' . "\0" . 'monto', '' . "\0" . 'Juventud\\Core\\model\\MontoCuota' . "\0" . 'year', '' . "\0" . 'Juventud\\Core\\model\\MontoCuota' . "\0" . 'vencimiento'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MontoCuota $proxy) {
    ...
    public function getYearNro()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getYearNro', []);

        return parent::getYearNro();
    }
